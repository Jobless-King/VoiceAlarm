...
class NaverRecognizer implements SpeechRecognitionListener {
    ...
    public void onInactive() {
        ...
        Message msg = Message.obtain(mHandler, ClientState.CLIENT_INACTIVE);
        msg.sendToTarget();
    }
    ...
    public void onReady() {
        ...
        Message msg = Message.obtain(mHandler, ClientState.CLIENT_READY);
        msg.sendToTarget();
    }
    ...
    public void onRecord(short[] speech) {
        ...
        Message msg = Message.obtain(mHandler, ClientState.AUDIO_RECORDING, speech);
        msg.sendToTarget();
    }
    ...
    public void onPartitialResult(String result) {
        ...
        Message msg = Message.obtain(mHandler, ClientState.PARTIAL_RESULT, result);
        msg.sendToTarget();
    }
    ...
    public void onResult(Object[] result) {
        ...
        Message msg = Message.obtain(mHandler, ClientState.FINAL_RESULT, result);
        msg.sendToTarget();
    }

    @Override
    public void onError(int errorCode) {
        Message msg = Message.obtain(mHandler, ClientState.RECOGNITION_ERROR, errorCode);
        msg.sendToTarget();
    }
}